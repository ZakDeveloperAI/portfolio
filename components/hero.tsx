  ...
  return (
    <section ref={ref} id="home" className="scroll-mt-24 pt-24 pb-20 sm:pt-36 sm:pb-28">
      <div className="flex flex-col-reverse items-start gap-10 sm:flex-row sm:items-center sm:justify-between sm:gap-8">
        ...
        >
          <div className="absolute inset-0 -z-10 rounded-full bg-teal-300/10 blur-3xl" />
          <Image
            src={portrait}
            alt="Zakaria Belfakhir"
            priority
            className="h-40 w-40 object-cover object-top sm:h-56 sm:w-56"
          />
        </motion.div>
      </div>
